    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-red-900/20 dark:via-orange-900/20 dark:to-yellow-900/20">
            ...
            <div className="flex items-center space-x-3">
              <a href="/" className="flex items-center space-x-3 animate-slide-in-left">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Matsvinn Kalkulator</p>
                </div>
              </a>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 mb-6 animate-bounce-in">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
